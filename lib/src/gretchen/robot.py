...
class Robot:
    def __init__(self, motor_device_path = '/dev/grt_motor', camera_device_path = '/dev/grt_cam'):
        ...
        motor0_config["IGain"] = (1, ADDR_PRO_I_GAIN, 2)
        motor0_config["DGain"] = (1, ADDR_PRO_D_GAIN, 8)
        ...
        motor1_config["PGain"] = (1, ADDR_PRO_P_GAIN, 20)
        motor1_config["IGain"] = (1, ADDR_PRO_I_GAIN, 2)
        motor1_config["DGain"] = (1, ADDR_PRO_D_GAIN, 8)
